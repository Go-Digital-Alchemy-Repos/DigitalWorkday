...
const IMPORTANT_COLUMNS: SchemaColumnCheck[] = [
  ...
  { table: "client_user_access", column: "workspace_id" },
  { table: "client_user_access", column: "client_id" },
  { table: "client_user_access", column: "user_id" },
  { table: "client_user_access", column: "access_level" },
  { table: "user_client_access", column: "tenant_id" },
  ...
  { table: "client_divisions", column: "tenant_id" },
  { table: "client_divisions", column: "client_id" },
  { table: "division_members", column: "tenant_id" },
  { table: "division_members", column: "division_id" },
  { table: "division_members", column: "user_id" },
  { table: "comments", column: "visibility" },
  { table: "comment_mentions", column: "comment_id" },
