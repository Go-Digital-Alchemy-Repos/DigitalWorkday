/**
 * Subtasks Legacy Router (remaining after Tasks Core migration — Prompt #12)
 *
 * Contains subtask endpoints NOT migrated in Slice 2:
 ...
 *
 * These will be migrated in Slice 3 (Prompt #13).
 */
