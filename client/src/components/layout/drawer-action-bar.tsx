      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        {showComplete && onMarkComplete && (
          <Button
            ...
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover-elevate active-elevate-2 border border-[#71a615] md:min-h-9 px-4 py-2 text-white min-h-[44px] bg-[#85c219]"
