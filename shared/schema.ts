...
export const clientConversations = pgTable("client_conversations", {
  ...
  portalParticipantUserIds: jsonb("portal_participant_user_ids").$type<string[] | null>(),
  ...
  index("client_conversations_recipient_idx").on(table.recipientUserId),
  index("client_conversations_portal_participants_idx").using("gin", table.portalParticipantUserIds),
