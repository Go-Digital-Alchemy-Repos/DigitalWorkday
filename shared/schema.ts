...
export const users = pgTable("users", {
  ...
  costRate: numeric("cost_rate").notNull().default("0"),
...
export const clients = pgTable("clients", {
  ...
  postalCode: text("postal_code"),
  country: text("country"),
  mailingAddressLine1: text("mailing_address_line_1"),
  mailingAddressLine2: text("mailing_address_line_2"),
...
export const notificationPreferences = pgTable("notification_preferences", {
  ...
  taskDeadlineEmail: boolean("task_deadline_email").default(false).notNull(),
  taskAssignedEmail: boolean("task_assigned_email").default(false).notNull(),
  taskCompletedEmail: boolean("task_completed_email").default(false).notNull(),
  commentAddedEmail: boolean("comment_added_email").default(false).notNull(),
  commentMentionEmail: boolean("comment_mention_email").default(false).notNull(),
  projectUpdateEmail: boolean("project_update_email").default(false).notNull(),
  projectMemberAddedEmail: boolean("project_member_added_email").default(false).notNull(),
  taskStatusChangedEmail: boolean("task_status_changed_email").default(false).notNull(),
  chatMessageEmail: boolean("chat_message_email").default(false).notNull(),
  clientMessageEmail: boolean("client_message_email").default(false).notNull(),
  supportTicketEmail: boolean("support_ticket_email").default(false).notNull(),
  workOrderEmail: boolean("work_order_email").default(false).notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
}, (table) => [
