...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        display: ["var(--text-display)", { lineHeight: "var(--leading-display)", fontWeight: "var(--weight-bold)", letterSpacing: "var(--tracking-tight)" }],
        h1: ["var(--text-h1)", { lineHeight: "var(--leading-h1)", fontWeight: "var(--weight-bold)", letterSpacing: "var(--tracking-tight)" }],
        h2: ["var(--text-h2)", { lineHeight: "var(--leading-h2)", fontWeight: "var(--weight-semibold)", letterSpacing: "var(--tracking-tight)" }],
        h3: ["var(--text-h3)", { lineHeight: "var(--leading-h3)", fontWeight: "var(--weight-semibold)" }],
        h4: ["var(--text-h4)", { lineHeight: "var(--leading-h4)", fontWeight: "var(--weight-medium)" }],
        body: ["var(--text-body)", { lineHeight: "var(--leading-body)" }],
        small: ["var(--text-small)", { lineHeight: "var(--leading-small)" }],
        caption: ["var(--text-caption)", { lineHeight: "var(--leading-caption)" }],
        overline: ["var(--text-overline)", { lineHeight: "var(--leading-overline)", fontWeight: "var(--weight-medium)", letterSpacing: "var(--tracking-overline)" }],
      },
      fontFamily: {
        sans: ["var(--font-sans)"],
